...
- no arquivo `settings.py`, linha 78 configurar:
```python
    DATABASES = {
    'default': {
...
- no arquivo `receitas\models.py`, configurar:
```python
...
Preparar todas as models criadas para migrar para serem migradas para o BD.
Usar terminal:
`python manage.py makemigrations`
- [X] Realizando a migration
Executar a migrações pendentes
Usar terminal:
